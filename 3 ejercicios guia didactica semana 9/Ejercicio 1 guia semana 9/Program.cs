...
namespace Ejercicio_1
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            do
            {
                ...
                switch (opcion)
                {
                    ...
                    case 6: Console.WriteLine("uso del inventario correcto, vuelva pronto."); break;
        ...
        {
            Console.WriteLine("\n--- Eliminar Producto ---");
            Console.Write("Ingresa el código del producto que desea eliminar: ");
            int codigo = int.Parse(Console.ReadLine());
        ...
        {
            Console.WriteLine("\n--- Consultar Producto ---");
            Console.Write("Ingresa el código del producto que va a consultar: ");
            int codigo = int.Parse(Console.ReadLine());
